...
export const fetchSoilDetails = async () => {
  const res = await fetch(`${BASE_URL}/soil`);
...
export const updateSoil = async (id, data) => {
  try {
    const res = await fetch(`${BASE_URL}/soil/${id}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json", "x-role": "admin" },
...
export const fetchDistributors = async () => {
  const res = await fetch(`${BASE_URL}/distributors`);
  return res.ok ? res.json() : [];
};
...
export const updateDistributor = async (id, data) => {
  try {
    const res = await fetch(`${BASE_URL}/distributors/${id}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json", "x-role": "admin" },
      body: JSON.stringify(data),
    });
